...
import com.mvc.demo.repositories.FournisseurRepository;
import com.mvc.demo.service.AppelOffreService;
import com.mvc.demo.service.FornisseurService;
...
public class FornisseurServiceImp implements FornisseurService {
    ...
    public AppelOffre validate(Long id_fournissuer , Long ao) {
        ...
        if(ao1 != null){
            Fournisseur fournisseur = this.getFournisseurById(id_fournissuer);
